...
func TestAdd(t *testing.T) {
	var e1, e2 route53.Route53EndpointRuleReference
...
func TestHas(t *testing.T) {
	var e1, e2, e3 route53.Route53EndpointRuleReference
	e := createRandomObject(e1)
	if v, ok := e.(route53.Route53EndpointRuleReference); ok {
		e1 = v
	}
...
func TestEach(t *testing.T) {
	...
	found := make(map[route53.Route53EndpointRuleReference]bool)

	s1.Each(func(item route53.Route53EndpointRuleReference) bool {
		found[item] = true
		return true
	})
