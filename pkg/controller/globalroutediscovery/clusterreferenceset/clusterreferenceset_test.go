...
func TestAdd(t *testing.T) {
	var e1, e2 redhatcopv1alpha1.ClusterReference
...
func TestHas(t *testing.T) {
	var e1, e2, e3 redhatcopv1alpha1.ClusterReference
	e := createRandomObject(e1)
	if v, ok := e.(redhatcopv1alpha1.ClusterReference); ok {
		e1 = v
	}
...
func TestEach(t *testing.T) {
	...
	found := make(map[redhatcopv1alpha1.ClusterReference]bool)

	s1.Each(func(item redhatcopv1alpha1.ClusterReference) bool {
		found[item] = true
		return true
	})
